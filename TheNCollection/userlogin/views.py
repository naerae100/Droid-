...
def register_user(request):
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            return render(request, 'userlogin/register.html', {'form_user': form})
    context = {
...
def get_users(request):
    ...
    return render(request, 'userlogin/users.html', context)
...
def get_admins(request):
    ...
    return render(request, 'userlogin/admins.html', context)
